    ...
    <fieldset class="container my-4 shadow p-3 mb-5 bg-white rounded">
        ...
        <form action="" method="POST">
            ...
            <div class="my-3 row">
                ...
                <div class="col-4">
                    <input type="text" name="name" id="name" class="form-control" pattern="^[A-Za-z éèêëàâäôöûüç '-]+$" required>
                </div>
                <label for="lastname" class="col-form-label col-2">Votre Prénom*</label>
                <div class="col-4">
                    <input type="text" name="lastname" id="lastname" class="form-control"pattern="^[A-Za-z éèêëàâäôöûüç '-]+$" required>
                </div>
            </div>
            <!-- date de naissance -->
            <div class="my-3 row">
            ...
            <!-- xp programmation -->
            <div class="my-3 row">
                <label for="hack" class="col-form-label col-2">Avez vous déjà eu une expérience avec la programmation et/ou l'informatique avant de remplir ce formulaire ?</label>
                <div class="col-6">
                    <textarea name="hack" id="hack" class="form-control" style="height: 200px">Racontez-nous vos expériences</textarea>
                </div>
            </div>
            <div class="row">
                <button type="submit" class="offset-4 col-4 btn btn-info btn-lg" disabled> Soumettre le formulaire</button>
            </div>
        </form>    
    </fieldset>
